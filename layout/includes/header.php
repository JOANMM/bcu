...
<head>
    ...
    <link href='//fonts.useso.com/css?family=Droid+Sans:400,700' rel='stylesheet' type='text/css'>
        ...
        <div class="searchbox">
            <form action="<?php p($CFG->wwwroot) ?>/course/search.php">
                ...
                <div class="search-box grey-box bg-white clear-fix">
                    <input placeholder="课程搜索" accesskey="6" class="search_tour bg-white no-border left search-box__input ui-autocomplete-input" type="text" name="search" id="search-1" autocomplete="off">
...
<?php echo $OUTPUT->blocks('banere-top', 'baneretop'); ?>
<div id="navwrap">
    <div class="container">
        <div class="navbar">
...
<script type="text/javascript">
    window.onload= function(){
        var sectionnameul = document.getElementsByClassName('sectionname');
         for(var i=0;i<sectionnameul.length;i++){
            sectionnameul[i].onclick=show_hidden;
         }
         function show_hidden(event){
           $($(event.target).next().next()).slideToggle("fast");
         }       
    }
    console.log("开发人员：戴兴旺，曾学兵，刘涛,韩梦莹,黄璐");
    console.log("如果想加入我们，请发简历到Ceo@Cloudkz.cn");
</script>
